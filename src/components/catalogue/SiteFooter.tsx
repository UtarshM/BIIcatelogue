        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-6 sm:gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#value-pillars" className="hover:text-white transition">Competitive Pricing</a></li>
              <li><a href="#value-pillars" className="hover:text-white transition">Fastest Delivery</a></li>
            </ul>
          </div>
