...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    ...
    links: [
      ...
      { rel: "icon", href: "/favicon.ico?v=bii", type: "image/x-icon" },
      { rel: "icon", href: "/favicon.png?v=bii", type: "image/png" },
      { rel: "icon", href: "/favicon-32x32.png?v=bii", sizes: "32x32", type: "image/png" },
      { rel: "icon", href: "/favicon-16x16.png?v=bii", sizes: "16x16", type: "image/png" },
      { rel: "apple-touch-icon", href: "/apple-touch-icon.png?v=bii", sizes: "180x180" },
